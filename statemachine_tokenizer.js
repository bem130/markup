...
function main(tokenizertransionmd,nmlts) {
    ...
    let nmlts_before = fRead(nmlts);
    let nmlts_new = "";
    nmlts_new += nmlts_before.substring(0,nmlts_before.indexOf("/*TokenizerReplace_states_start*/")+"/*TokenizerReplace_states_start*/".length) +"\n";
    nmlts_new += indent2+"this.tokenizerstates = [\"" + statenamearr.join("\",\"") + "\"]" +"\n";
    nmlts_new += indent2+nmlts_before.substring(nmlts_before.indexOf("/*TokenizerReplace_states_end*/"),nmlts_before.indexOf("/*TokenizerReplace_switch_start*/")+"/*TokenizerReplace_switch_start*/".length) +"\n";
    for (line of ret1) {
        nmlts_new += indent1+line +"\n";
    }
    nmlts_new += indent1+nmlts_before.substring(nmlts_before.indexOf("/*TokenizerReplace_switch_end*/"));
    fWrite(nmlts,nmlts_new);
}
let condition = {
    "space": " ",
    "sharp": "#",
...
main("./spec/nml-tokenizer-statetransition.md","./nml.ts")